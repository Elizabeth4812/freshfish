...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference("Contacto.count") do
      post contactos_url, params: { contacto: { asunto: @contacto.asunto, correo: @contacto.correo, mensaje: @contacto.mensaje, nombre: @contacto.nombre } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { asunto: @contacto.asunto, correo: @contacto.correo, mensaje: @contacto.mensaje, nombre: @contacto.nombre } }
